...
insert  into `data_riwayat`(`ID`,`DATA_TABLE`,`AKSI`,`OLEH`,`TANGGAL`) values (1,'TABLE LAPORANHD - DATA CIMANDIRI','TAMBAH','DIDIN','2020-10-13 07:51:05'),(2,'TABLE LAPORANHD - UPDATE STATUS ','SELESAI','DIDIN','2020-10-13 07:53:05'),(3,'TABLE LAPORANHD - UPDATE STATUS ','SELESAI','ASEP','2020-10-13 07:54:13'),(4,'TABLE LAPORANHD - UPDATE STATUS ','MENUNGGU PERSETUJUAN','EKO','2020-10-13 07:55:26'),(5,'TABLE LAPORANHD - UPDATE STATUS ','DISETUJUI','EKO','2020-10-13 08:00:32'),(6,'TABLE LAPORANHD - UPDATE STATUS ','DIKERJAKAN','EKO','2020-10-13 08:00:39'),(7,'TABLE LAPORANHD - UPDATE STATUS ','SELESAI','EKO','2020-10-13 08:01:42'),(8,'TABLE LAPORANHD - UPDATE STATUS ','SELESAI','EKO','2020-10-13 08:03:52'),(9,'TABLE LAPORANHD - UPDATE STATUS ','DISETUJUI','EKO','2020-10-13 08:06:13'),(10,'TABLE LAPORANHD - UPDATE STATUS ','DIKERJAKAN','EKO','2020-10-13 08:06:23'),(11,'TABLE LAPORANHD - UPDATE STATUS ','SELESAI','EKO','2020-10-13 08:06:30'),(12,'TABLE BENCANAHD - DATA CIMANDIRI','TAMBAH','EKO','2020-10-13 08:13:25'),(13,'TABLE BENCANAHD - DATA ','EDIT ','EKO','2020-10-13 08:14:20'),(14,'TABLE BENCANAHD - DATA ','EDIT ','EKO','2020-10-13 08:17:42'),(15,'TABLE LAPORANHD - DATA CIMANDIRI','HAPUS','REZA','2020-10-13 08:47:36');
