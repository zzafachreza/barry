...
<div class="row">
  <div class="col col-sm-12" style="padding: 5%;padding-left: 15%;padding-top: 5%;">
     ...
     <blockquote class="blockquote" style="margin-top: 5%">
         <h1>SI JUET</h1>
        <footer class="blockquote-footer">"SI JUET" adalah aplikasi berbasis web yang dapat melakukan Integrasi Pelaporan Data Pemeliharaan Irigasi</footer>
      </blockquote>
  </div>
   <div class="col col-sm-6">
    <center>
      <img src="assets/images/login.svg" width="100%" height="300" class="img">
    </center>
  </div>
  <div class="col col-sm-6">
