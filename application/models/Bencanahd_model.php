...
class Bencanahd_model extends CI_Model{
	...
	function getData(){
	 ...
	 $sql ="INSERT INTO data_bencanadt(ID_LAPORANHD,NAMA_SALURAN,PENYEBAB_KERUSAKAN,JENIS_KERUSAKAN,TANAH,BATU,BETON,PINTU_AIR,GORONG_GORONG,LAIN_LAIN_KERUSAKAN,LUAS_TERANCAM,TINDAKAN_PERBAIKAN,BIAYA_PERBAIKAN,DIKERJAKAN_OLEH,DIUSULKAN_OLEH,FOTO_BENCANA,FOTO_BENCANA1,FOTO_BENCANA2,FOTO_BENCANA3,FOTO_BENCANA4,FOTO_BENCANA5,TANAH_B,BATU_B,BETON_B,PINTU_AIR_B,GORONG_GORONG_B,LAIN_LAIN_KERUSAKAN_B,LUAS_TERANCAM_B) VALUES('$ID_LAPORANHD','$NAMA_SALURAN','$PENYEBAB_KERUSAKAN','$JENIS_KERUSAKAN','$TANAH','$BATU','$BETON','$PINTU_AIR','$GORONG_GORONG','$LAIN_LAIN_KERUSAKAN','$LUAS_TERANCAM','$TINDAKAN_PERBAIKAN',($TANAH_B+$BATU_B+$BETON_B+$PINTU_AIR_B+$GORONG_GORONG_B+$LAIN_LAIN_KERUSAKAN_B+$LAIN_LAIN_KERUSAKAN_B),'$DIKERJAKAN_OLEH','$DIUSULKAN_OLEH','$FOTO_BENCANA','$VALUEFOTO_BENCANA1','$VALUEFOTO_BENCANA2','$VALUEFOTO_BENCANA3','$VALUEFOTO_BENCANA4','$VALUEFOTO_BENCANA5','$TANAH_B','$BATU_B','$BETON_B','$PINTU_AIR_B','$GORONG_GORONG_B','$LAIN_LAIN_KERUSAKAN_B','$LUAS_TERANCAM_B');";
