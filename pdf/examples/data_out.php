...
$sql = $conn->query("SELECT * FROM output_hd where kd_in='$kd'");
  $row = $sql->fetch();
...
$html = ' <h2>Barang Keluar</h2><table border="0" width="100%" cellspacing="5">
            <tr>
                <td width="100px">Kode Output </td><td>:'.$row['kd_in'].'</td>
            </tr>
            <tr>
                <td width="100px">Tanggal Output</td><td>:'.$row['tgl'].'</td>
            </tr>
...
$hasilD = $conn->query("SELECT*FROM out_dt where kd_in='$kd'");
$noD=1;
