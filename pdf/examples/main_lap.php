...
$html = '<h2>Laporan Maintenance '.$p[0].'sampai'.$p[1].'</h2>
...
<table style="font-size:15px" border="0" cellpadding="7">
  <tr>
   <th colspan="2">&nbsp;</th>
    <th colspan="2">&nbsp;</th>
     ...
     <th align="center" colspan="2">'.number_format($disc).' Kali</th>
  </tr>
  <tr>
      <th colspan="2">&nbsp;</th>
    <th colspan="2">&nbsp;</th>
  ...
  <tr>
      <th colspan="2">&nbsp;</th>
    <th colspan="2">&nbsp;</th>
   <th align="center" colspan="4"><i>*'.angkaTerbilang($hrg).'rupiah</i></th>
  </tr>
...
$pdf->Output('data-laporan-main.pdf', 'I');
