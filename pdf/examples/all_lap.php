...
//untuk maintenance
                         $sql4 =$conn->query($hrg2);
                          $h1 = $sql4->fetch();
                          $hrg2 = $h1['jml_hrg'];

                          $sql5 =$conn->query($disc2);
                          $d1 = $sql5->fetch();
                          $disc2 = $d1['jml_kun'];
...
$a6  = $r['plat'];     
$a7  = $r['jasa'];
$a8  = number_format($r['harga']);
$a9  = number_format($r['kun']);
  ...
  <tr>
   <th colspan="2">&nbsp;</th>
    <th colspan="2">&nbsp;</th>
     ...
     <th align="center" colspan="2">'.number_format($disc2).' Kali</th>
  </tr>
  <tr>
      <th colspan="2">&nbsp;</th>
    <th colspan="2">&nbsp;</th>
   <th bgcolor="silver" colspan="2">Total Harga</th>
   <th bgcolor="silver" align="right" colspan="2">Rp. '.number_format($hrg2).'</th>
  </tr>
  <tr>
      <th colspan="2">&nbsp;</th>
    <th colspan="2">&nbsp;</th>
   <th align="center" colspan="4"><i>*'.angkaTerbilang($hrg2).'rupiah</i></th>
  </tr>
...
$html.='<hr>   
<br> 
<table style="font-size:20px" border="0" cellpadding="7">
  <tr>
     <th align="center"  colspan="2">Laporan Semua Transaksi Dari '.$p[0].'sampai'.$p[1].'</th> 
  </tr>
  <tr>
      <th bgcolor="lightgreen" align="center" colspan="2">Rp. '.number_format($hrg2+$tot).'</th>
  </tr>
  <tr>
   
   <th align="center" colspan="2"><i>*'.angkaTerbilang($hrg2+$tot).'rupiah</i></th>
  </tr>
